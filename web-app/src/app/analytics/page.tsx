...
export default function AnalyticsPage() {
  const { kpis, chartData, platformStats, isLoading, period, setPeriod } = useAnalyticsOverview();
  ...
  const donutData = platformStats.map((s) => ({ name: s.platform, value: s.conversations }));
      ...
      <div className="max-w-[900px] mx-auto px-8 py-8">
            ...
            return (
              <div key={kpi.label} className="bg-white border border-zinc-200 rounded-xl p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Badge
                    variant={kpi.deltaPositive ? "success" : "destructive"}
        ...
        <div className="bg-white border border-zinc-200 rounded-xl p-5 mb-4">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <AreaChart data={chartData} margin={{ top: 4, right: 4, left: -16, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="followedUp" name="Followed up" stroke="#10b981" strokeWidth={1.5} strokeDasharray="4 3" fill="url(#gradFU)"    dot={false} activeDot={{ r: 4 }} />
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div className="bg-white border border-zinc-200 rounded-xl p-5">
            ...
            <ResponsiveContainer width="100%" height={170}>
              <BarChart
                data={platformStats.map((s) => ({ name: s.platform.charAt(0).toUpperCase() + s.platform.slice(1), rate: s.rate }))}
